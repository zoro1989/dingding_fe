              ...
              <li>
                <div class="item-content item-input">
                  <div class="item-inner">
                    ...
                    <div class="item-input-wrap">
                      <input type="text" name="arrangeGoodsName" placeholder="请输入调货人姓名" :value="autoData.userName" :disabled="isReadonly" required validate>
                    </div>
                  </div>
                </div>
              </li>
              <li>
                <div class="item-content item-input">
                  <div class="item-inner">
                    ...
                    <div class="item-input-wrap">
                      <input type="text" name="arrangeGoodsOffice" placeholder="请输入调货人分公司" :value="autoData.officeName" :disabled="isReadonly" required validate>
                    </div>
                  </div>
                </div>
              </li>
              <li>
                <div class="item-content item-input">
                  <div class="item-inner">
                    ...
                    <div class="item-input-wrap">
                      <input type="text" name="arrangeGoodsBranchOffice" placeholder="请输入调货人支公司" :value="autoData.branchOfficeName" :disabled="isReadonly" required validate>
                    </div>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="item-content item-input">
                  <div class="item-inner">
                    ...
                    <div class="item-input-wrap">
                      <input type="text" name="goodsNumber" placeholder="请输入调货产品数量" :disabled="isReadonly" required validate>
                    </div>
                  </div>
                </div>
              </li>
              <li>
                <div class="item-content item-input">
                  <div class="item-inner">
                    ...
                    <div class="item-input-wrap">
                      <input type="text" name="goodsBatchNumber" :value="goodsBatchNumber" placeholder="请输入调货产品批号" disabled>
                    </div>
                  </div>
                </div>
              </li>
              <li>
                <div class="item-content item-input">
                  <div class="item-inner">
                    ...
                    <div class="item-input-wrap">
                      <input type="text" name="arrangeRemarks" placeholder="请输入调货原因" :disabled="isReadonly" required validate>
                    </div>
                  </div>
                </div>
              </li>
