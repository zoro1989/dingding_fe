<template>
  <div class="home">
    ...
    <div class="block">
      <div class="row">
        <div class="link-box">
          <f7-button fill color="orange" class="button-link" @click="OnClick">
            <i class="fa fa-address-card-o"></i>
          </f7-button>
          <span>通知公告</span>
        </div>
        <div class="link-box">
          <f7-button fill color="pink" class="button-link" @click="OnClick">
    ...
    <div class="block">
      ...
      <div class="row">
        <div class="link-box">
          <f7-button fill class="button-link" @click="OnClick">
            <i class="fa fa-address-card-o"></i>
          </f7-button>
          <span>终端医疗申请</span>
        </div>
        ...
        <div class="link-box">
          <f7-button color="green" fill class="button-link" @click="OnClick">
            <i class="fa fa-pencil"></i>
          </f7-button>
          <span>终端医疗审批</span>
        </div>
